        ...
        <div class="col-md-6">
            ...
            <form id="manage_payment">
                ...
                <div class="form-group">
                    <p>Plan Membership Fee: </i> <b
                            class="float-right"><?php echo ($pcount <= 0) ? number_format($pamount, 2) : 'Paid Already' ?></b>
                    </p>
                ...
                <hr>
                <div class="form-group">
                    <p>Amount Payable: </i> <b
                            class="float-right"><?php echo ($pcount <= 0) ? number_format(($pamount), 2) : number_format(($ppamount ), 2) ?></b>
                    </p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="member_id" value="<?php echo $mid_no; ?>">
                </div>
