                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-right" min="1" name="plan">
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary edit_plan" type="button"
                                            data-id="<?php echo $row['plan'] ?>">Edit</button>
                                        <button class="btn btn-sm btn-danger delete_plan" type="button"
