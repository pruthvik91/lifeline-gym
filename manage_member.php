...
<div class="container-fluid">
    <form action="" id="manage-member">
        ...
        <input type="hidden" name="receipt_id" value="<?php echo isset($_GET['receipt_id']) ? $_GET['receipt_id'] : '' ?>" class="form-control">
        ...
        <div class="col-md-4">
            ...
            <input type="date" placeholder="dd-mm-yyyy" name="start_date" class="form-control"
        ...
        <div class="row form-group">
            <div class="col-md-4">
                ...
                <select name="plan_id" required="required" class="custom-select select2" id="">
                    ...
                    <option value="<?php echo $row['id'] ?>"
                        ...
                        <?php echo ucwords($row['plan']) ?> <?php echo isset($row['plan_type']) ? ucfirst($row['plan_type']) : 'Months'; ?></option>
                    <?php endwhile; ?>
                </select>
            </div>
            <div class="col-md-4">
                <label class="control-label">batch</label>
                <select name="batch" required="required" class="custom-select select2" id="">
                    <option value=""></option>  
            ...
            <div class="col-md-4">
                ...
                <select name="package_id" required="required" class="custom-select select2" id="">
                    ...
                    ?>
                    <option value="<?php echo $row['id'] ?>"
                        <?php echo isset($package_id) && $package_id == $row['id'] ? 'selected' : '' ?>>
                        <?php echo ucwords($row['package']) ?></option>
                    <?php endwhile; ?>
                </select>
            </div>
