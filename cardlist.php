								...
								?>
									<tr>
										...
										<td class="text-center">
											...
											?>
											<button class="btn btn-sm btn-outline-primary view__member" type="button" data-id="<?php echo $row['member_id'] ?>">card</button>
...
<script>
	...
	$('.view__member').click(function(){
		uni_modal("<i class='fa fa-address-card'></i> Member Plan Details","card.php?id="+$(this).attr('data-id'),'large')
